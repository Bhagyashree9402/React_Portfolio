...
import Nav from './Nav'
import finalproject from "../img/Finalproject.png"
                        ...
                        <CardActionArea>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" color="textSecondary" component="p">
                                    Project "Mumble" a dating app began on August 22nd, 2020 and was produced by Jimit Mehta,
                                    Louise Lee,Kenny Ngo,Meianna Oeser and I.
                                    An incredibly easy-to-use UI where we ask you simple questions about yourself. Create a comprehensive profile.
                                    Then we will match you with incredible people in your area using our complex Recommendation Algorithm.
                                </Typography>
                            </CardContent>
                            <CardActions>
                                <Button size="small" color="primary" href=" https://mumble-dating-app.herokuapp.com/">
                                    FINAL PROJECT
                          </Button>
                                <Button size="small" color="primary" href="https://github.com/Bhagyashree9402/dating-app.git">
                                    GIT REPO
                          </Button>
                            </CardActions>
                        </CardActionArea>
